...
class ChessControlSystem:
    states = [
        'main_menu',
        {'name': 'gameplay', 'children': ['white_turn', 'black_turn']},
    ...
    def __init__(self):
        ...
        self.machine = Machine(model=self, states=ChessControlSystem.states, initial='main_menu')

        self.machine.add_transition(trigger='start_game', source='main_menu', dest='gameplay_white_turn', after='on_game_start')
        self.machine.add_transition(trigger='white_move_done', source='gameplay_white_turn', dest='gameplay_black_turn', after='process_white_move')
        self.machine.add_transition(trigger='black_move_done', source='gameplay_black_turn', dest='gameplay_white_turn', after='process_black_move')
        self.machine.add_transition(trigger='open_settings', source='gameplay', dest='settings')

        ...
        with self.canvas:
            ...
            for row in range(2, self.rows):
                for col in range(self.cols):
                    ...
                    square_occupancy = self.board_occupancy[8-col][row-2]
...
class GantryControlScreen(Screen):
    ...
    def __init__(self, control_system, **kwargs):
        ...
        self.target_board = GantryTargetWidget(control_system=self.control_system)
        ...
        controls.add_widget(Button(text="Home", on_press=lambda instance: self.gantry.home()))

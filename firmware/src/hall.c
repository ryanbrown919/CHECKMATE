...
const uint32_t hall_to_board_mapping[16][8] = {
    /* q1    q2     q3     q4*/
    {3, 5,  0, 2,  4, 2,  7, 5}, /* HALL  7 mapping */
    {3, 4,  0, 3,  4, 3,  7, 4}, /* HALL  3 mapping */
    {2, 4,  1, 3,  5, 3,  6, 4}, /* HALL  2 mapping */
    {2, 5,  1, 2,  5, 2,  6, 5}, /* HALL  6 mapping */
    {0, 4,  3, 3,  7, 3,  4, 4}, /* HALL  0 mapping */
    {0, 5,  3, 2,  7, 2,  4, 5}, /* HALL  4 mapping */
    {1, 5,  2, 2,  6, 2,  5, 5}, /* HALL  5 mapping */
    {1, 4,  2, 3,  6, 3,  5, 4}, /* HALL  1 mapping */
    {2, 6,  1, 1,  5, 1,  6, 6}, /* HALL 10 mapping */
    {3, 6,  0, 1,  4, 1,  7, 6}, /* HALL 11 mapping */
    {3, 7,  0, 0,  4, 0,  7, 7}, /* HALL 15 mapping */
    {2, 7,  1, 0,  5, 0,  6, 7}, /* HALL 14 mapping */
    {0, 6,  3, 1,  7, 1,  4, 6}, /* HALL  8 mapping */
    {1, 6,  2, 1,  6, 1,  5, 6}, /* HALL  9 mapping */
    {1, 7,  2, 0,  6, 0,  5, 7}, /* HALL 13 mapping */
    {0, 7,  3, 0,  7, 0,  4, 7}  /* HALL 12 mapping */
};
...
uint32_t hall_get_square(uint32_t x, uint32_t y) {
    for (uint32_t i = 0; i < 16; i++) {
        for (uint32_t j = 0; j < 4; j++) {
            if (hall_to_board_mapping[i][j * 2] != x || hall_to_board_mapping[i][j * 2 + 1] != 7 - y) 
                continue;
